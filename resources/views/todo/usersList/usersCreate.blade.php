...
@section('content')
    ...
    <div class="alert d-none alert-danger mt-2 alert-no" role="alert"></div>
    <div class="alert d-none alert-success mt-2 alert-no" role="alert"></div>
    <div class="alert d-none alert-secondary" role="alert">
    ...
    {{-- <form class="formList">
        ...
        <div class="formLitsInput">
            <input class="form-control mt-2" required name="list" type="text" id="list" placeholder="Ведите название листа">
                <button type="submit" class="addPoint btn border mb-2">Добавить поинт</button>
            <div class="point0">
                <input class="point form-control mt-3" required name="point[][name]"  type="text" id="point0" placeholder="Ведите название поинта">
                <input class="pointImage form-control mt-3" required name="point0"  type="file" id="pointImage0">
                <button type="submit" class="addTag btn border mb-2">Добавить тег</button><button type="submit" class="deletePoint btn border mb-2">Удалить поинт</button>
                <div class="tag0">
                    <input class="form-control" name="point[0][tag][]" type="text" id="" placeholder="Ведите название тега">
                    <button type="submit" class="deleteTag btn border mb-2">Удалить тег</button>
                </div>
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if (result['ok']) {
                    ...
                    $('.alert-success').removeClass('d-none').empty().append(`Лист "${result['name']}" успешно создан!`);
                    ...
                    $('.alert-danger').removeClass('d-none').append(`Лист не удалось создать!`);
                }
        }});
